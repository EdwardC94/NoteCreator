(function() {
	angular.module("NoteCreator", [])
		.controller("CancellationCtrl", ["$scope", function($scope){
			$scope.data = {
				pn : "",
				phn : "",
				email : "",
				...
				l4d : "",
                                availableOptions: [
                                   {id: '0', reason: 'Cancellation Reason', exp: ''},                                                                                                                      {id: '1', reason: 'Unintended Purchase', exp: 'the customer made the purchase of the Policy by mistake'},
                                ...
                                selectedOption: {id: '0', reason: 'Cancellation Reason', exp: ''} //This sets the default value of the select in the ui								
			};
